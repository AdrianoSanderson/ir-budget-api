...
export class EmailService {
  ...
  async sendBudgetEmail(budget: Budget) {
    const response = await this.resend.emails.send({
      ...
      subject: `Orçamento de ${budget.name} recebido`,
      html: `
        <div style="font-family: Arial, sans-serif; padding: 16px;">
          ...
          <p><strong>13. Se tiver outras informações que não foram citadas anteriormente, por favor, descreva abaixo:</strong></p>
          <p>${budget.notes || '-'}</p>
